...
class TextServiceGeneratedAiTests {
    ...
    void testRemoveConsonants_removesAllConsonants() {
        // GIVEN
        String consonantInput = "Beautiful";
// WHEN
String result = textService.removeConsonants(consonantInput);
// THEN
...
// GIVEN
String vowelInput = "aeiou";
// WHEN
String result = textService.removeConsonants(vowelInput);
// THEN
