...
public class TextServiceGeneratedAiTests {
    ...
    void testStats() {
        ...
        assertThat(stats.get("length")).isEqualTo(input.length());
    }
    ...
    void testReplace() {
        ...
        // THEN
        assertThat(result).isEqualTo("I like bananas");
    }
    ...
    void testConvertJsonToYaml() {
        ...
        try (MockedStatic<TextConversionUtil> mocked = Mockito.mockStatic(TextConversionUtil.class)) {
            mocked.when(() -> TextConversionUtil.convertJsonToYaml(json)).thenReturn("name: John");
    ...
    void testConvertJsonToXml() {
        ...
        String json = "{\"name\":\"John\"}";
        try (MockedStatic<TextConversionUtil> mocked = Mockito.mockStatic(TextConversionUtil.class)) {
            mocked.when(() -> TextConversionUtil.convertJsonToXml(json)).thenReturn("<name>John</name>");
