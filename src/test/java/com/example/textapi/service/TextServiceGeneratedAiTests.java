...
public class TextService {
    ...
    public String removeVowels(String input) {
        return input.replaceAll(VOWEL_PATTERN, "");
    }

    public String removeConsonants(String input) {
        return input.replaceAll(consonantPattern, "");
    }

    public String removePattern(String input, String regex) {
    ...
    public int countOccurrence(String input, String keyword) {
        int count = 0;
        if (input != null) {
            String[] words = input.split("\\sjava
+");
            for (String word : words) {
